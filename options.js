...
var fonty=['Calibri','Cormorant Infant','Alegreya','Alice','Tenor Sans','Prosto One','Philosopher','Pangolin','Oranienbaum','Old Standard','Neucha','Ledger','Kurale','Gabriela','Cuprum'];
scrollHider();
