...
//else if(m==='s'||m==='ы')saveHid();
					...
					window.open('https://id.twitch.tv/oauth2/authorize?response_type=token&client_id=mwjifiu32yfpnpgsmdeeuwa4wyb9se&redirect_uri=http://localhost&scope=chat:read+chat:edit+channel:moderate', 'Fuck', 'width=800,height=450,left=100,top=100,toolbar=no,directories=no,menubar=no,scrollbars=yes');
