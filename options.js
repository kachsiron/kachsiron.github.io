...
var fonty=['Calibri','Cormorant Infant','Alegreya','Alice','Vollkorn SC','Tenor Sans','Prosto One','Philosopher','Pangolin','Oswald','Oranienbaum','Old Standard','Neucha','Ledger','Kurale','Gabriela','Cuprum'];
scrollHider();
